...
!(function (t, e) {
    ...
    return (
        ...
        (function (t) {
            ...
            !(function () {
                ...
                for (var i = 2, n = 0; n < 64; )
                    e(i) && (n < 8 && (s[n] = r(t.pow(i, 0.5))), (a[n] = r(t.pow(i, 1 / 3))), n++),
                        i++;
            })();
            var c = [],
                h = (o.SHA256 = n.extend({
                ...
                var e = l,
                    ...
                    _ =
                        ((r.BlockCipher = h.extend({
                            cfg: h.cfg.extend({ mode: d, padding: p }),
                            reset: function () {
                                h.reset.call(this);
                                var t = this.cfg,
                                    e = t.iv,
                    ...
                    g = ((e.kdf = {}).OpenSSL = {
                        execute: function (t, e, r, i) {
                            i || (i = n.random(8));
                            var o = c.create({ keySize: e + r }).compute(t, i),
        ...
        (l.mode.ECB =
            (((a = l.lib.BlockCipherMode.extend()).Encryptor = a.extend({
                processBlock: function (t, e) {
        ...
        (l.pad.Iso10126 = {
            pad: function (t, e) {
                var r = 4 * e,
                    i = r - (t.sigBytes % r);
                t.concat(l.lib.WordArray.random(i - 1)).concat(
                    l.lib.WordArray.create([i << 24], 1)
                );
            },
            unpad: function (t) {
                var e = 255 & t.words[(t.sigBytes - 1) >>> 2];
        ...
        (l.mode.OFB =
            ((c = l.lib.BlockCipherMode.extend()),
            ...
            var t = l,
                ...
                f = (n.DES = i.extend({
                    ...
                    _doCryptBlock: function (t, e, r) {
                        ...
                        for (var i = 0; i < 16; i++) {
                            for (
                                var n = r[i], o = this._lBlock, s = this._rBlock, a = 0, l = 0;
                                l < 8;
                                l++
                            )
                                a |= c[l][((s ^ n[l]) & h[l]) >>> 0];
        ...
        (function () {
            ...
            function a() {
                ...
                (t[0] =
                    ...
                    (t[2] =
                        (o[2] + ((o[1] << 16) | (o[1] >>> 16)) + ((o[0] << 16) | (o[0] >>> 16))) |
                        0),
                    (t[3] = (o[3] + ((o[2] << 8) | (o[2] >>> 24)) + o[1]) | 0),
                    (t[4] =
                        (o[4] + ((o[3] << 16) | (o[3] >>> 16)) + ((o[2] << 16) | (o[2] >>> 16))) |
                        0),
                    (t[5] = (o[5] + ((o[4] << 8) | (o[4] >>> 24)) + o[3]) | 0),
                    (t[6] =
                        (o[6] + ((o[5] << 16) | (o[5] >>> 16)) + ((o[4] << 16) | (o[4] >>> 16))) |
                        0),
